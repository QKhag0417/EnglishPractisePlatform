    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="pt-[100px] pb-[60px] px-[120px] max-w-[1400px] mx-auto">
        ...
        <div className="mb-[32px]">
          ...
          <p className="text-[#1e1e1e] mb-[16px]">
            In Section 2, you will hear{" "}
            <strong>a monologue set in an everyday social context</strong> (for
            example, a speech about local facilities or a talk about
            arrangements for a meal).
          </p>
          <p className="text-[#1e1e1e] mb-[16px]">
            In Section 3, you will hear{" "}
            <strong>
              a conversation between up to four people set in an educational or
              training context
            </strong>{" "}
            (for example, a university tutor and student discussing an
            assignment).
          </p>
          <p className="text-[#1e1e1e] mb-[16px]">
            In Section 4, you will hear{" "}
            <strong>a monologue on an academic subject</strong> (for example, a
            university lecture).
          </p>
        </div>
        ...
        <div className="mb-[32px]">
          <p className="text-[#1e1e1e] mb-[16px]">
            Each section is heard only once. You will have time to read the
            questions before you listen and also time to check your answers. The
            recording lasts approximately 30 minutes, with 10 minutes to
        ...
        <p className="text-[#1e1e1e] mb-[16px]">
          You will answer 40 questions in total. A variety of question types are
          used, including:
        </p>
