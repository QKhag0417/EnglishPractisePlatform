        ...
        <div className="max-w-[1440px] mx-auto px-[60px] h-full flex items-center">
          <div className="text-white max-w-[600px]">
            ...
            <p className="font-['DM_Sans'] text-[18px] leading-[28px] mb-[8px] text-gray-200">
              Get ready for your 2025 IELTS exam by practicing our 100+ IELTS
              mock tests for <span className="font-semibold">FREE</span>.
            </p>
            <p className="font-['DM_Sans'] text-[14px] text-gray-300 mb-[30px]">
              <span className="text-[#fcbf65]">●</span> 100,000+ students are
              using our free services.
            </p>
            <button
            ...
            {skills.map((skill) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-[20px]">
                  <p
                    className={`font-['DM_Sans'] text-[20px] text-center ${
                      skill.highlighted
                        ? "text-[#fcbf65] font-extrabold"
          ...
          <div className="space-y-[30px]">
              ...
              <div>
                <p className="font-['DM_Sans'] font-medium text-[20px] leading-[32px] text-black">
                  <span className="font-semibold">
                    IELTS Mastermind simulates the real IELTS test format and
                    timing,
                  </span>{" "}
                  allowing learners to practice in an authentic exam environment
                  from home. It is accessible on both laptops and mobile
                  devices, offering flexible learning. All tests are based on
                  actual IELTS exams and follow the Cambridge IELTS book format.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#fcbf65] border-2 border-black rounded-[10px] p-[30px] flex items-center gap-[30px]">
              ...
              <div>
                <p className="font-['DM_Sans'] font-medium text-[20px] leading-[32px] text-black">
                  <span className="font-semibold">
                    Experience instant results with AI-powered scoring for
                    Speaking and Writing.
                  </span>{" "}
                  Paired with realistic mock tests featuring real IELTS audio,
                  the platform gives you immediate Listening and Reading band
                  scores and AI feedback analyses - everything you need to track
                  progress and improve effectively.
                </p>
              </div>
            </div>
